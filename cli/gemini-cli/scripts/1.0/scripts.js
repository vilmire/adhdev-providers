...
function resolveInput(state, input) { return input === undefined ? state : input; }
...
module.exports.parseOutput   = (state, input) => { const m = loadModule('parse_output.js'); return m ? m(input) : null; };
module.exports.detectStatus  = (state, input) => { const m = loadModule('detect_status.js'); return m ? m(input) : null; };
